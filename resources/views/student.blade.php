    ...
    <div class="container-fluid mt-4 " id="create-form">
        <div class="row">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    <img src="https://c1.wallpaperflare.com/preview/289/102/403/various-book-books-college.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <form action="{{ url('/store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label>RollNo</label>
                                <input name="RollNo" type="text" class="form-control"  placeholder="Enter RollNo">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>Gender</label>
                                <input name="Gender" type="text" class="form-control"  placeholder="Enter your gender">
                            </div>
                             <div class="form-group">
                                <label>Attendence</label>
                                <input name="Attendence" type="text" class="form-control"  placeholder="Enter the Attendence">
                            </div>
                            <div class="form-group">
            ...
            <section class="col-md-5">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ url('/update/'.$student->RollNo) }}" method="post">
                            @csrf
                            <div class="form-group">
                                <label>Roll No</label>
                                <input value="{{ $student->RollNo }}" name="RollNo" type="text" class="form-control"  placeholder="Enter cne">
                            </div>
                            <div class="form-group">
                                <label>First Name</label>
                            ...
                            <div class="form-group">
                                <label>Gender</label>
                                <input value="{{ $student->Gender }}" name="Gender" type="text" class="form-control"  placeholder="Enter your gender">
                            </div>
                            <div class="form-group">
                                <label>Attendence</label>
                                <input value="{{ $student->Attendence }}" name="Attendence" type="text" class="form-control"  placeholder="Enter the Attendence"> 
                            </div>
                            <div class="form-group">
                                <label>Speciality</label>
